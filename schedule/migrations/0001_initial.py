...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('schedule_courseschedule', (
            ('id', orm['schedule.CourseSchedule:id']),
            ('course', orm['schedule.CourseSchedule:course']),
            ('calendar_title', orm['schedule.CourseSchedule:calendar_title']),
        ))
    ...
    models = {
        ...
        'schedule.courseschedule': {
            'calendar_title': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
