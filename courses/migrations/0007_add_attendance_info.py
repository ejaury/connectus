...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('courses_attendance', (
            ('id', orm['courses.attendance:id']),
            ('course', orm['courses.attendance:course']),
            ('student', orm['courses.attendance:student']),
            ('date', orm['courses.attendance:date']),
        ))
        db.send_create_signal('courses', ['Attendance'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('courses_attendance')
